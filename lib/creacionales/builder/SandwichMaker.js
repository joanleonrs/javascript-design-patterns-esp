...
var SandwichMaker = function () {
    function SandwichMaker(builder) {
        _classCallCheck(this, SandwichMaker);

        this.builder = builder;
    }

    _createClass(SandwichMaker, [{
        key: "construirSandwich",
        value: function construirSandwich() {
