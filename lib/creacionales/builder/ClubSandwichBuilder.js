...
var ClubSandwichBuilder = function (_SandwichBuilder) {
    _inherits(ClubSandwichBuilder, _SandwichBuilder);

    function ClubSandwichBuilder() {
        _classCallCheck(this, ClubSandwichBuilder);

        return _possibleConstructorReturn(this, (ClubSandwichBuilder.__proto__ || Object.getPrototypeOf(ClubSandwichBuilder)).call(this));
    }

    _createClass(ClubSandwichBuilder, [{
        key: 'prepararPan',
...
exports.default = ClubSandwichBuilder;